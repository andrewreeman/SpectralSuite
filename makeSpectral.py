...
def get_jucebox(name : str, desc : str, directory : str) -> List[Jucer]:
	jucebox = []
	...
	for f in build_files:
		if f in boilerplate_files  and f not in existing_files:
			try:
			    ...
			    errors.append(f"@{f} - Error occurred while copying file.")
	return errors
