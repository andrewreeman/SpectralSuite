...
class frequencyMagnet : public STFT{
    public:
        frequencyMagnet(int size, int hops, int offset, int sRate) 
...
class binScrambler : public STFT{
  public:
        ...
        binScrambler(int size, int hops, int offset, int sRate, std::vector<int> *A, std::vector<int> *B) : STFT(size, hops, offset, sRate),
